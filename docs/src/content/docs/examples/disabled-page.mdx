...
Look at the right sidebar — there should be **no "Page Actions" section** above the table of contents. On mobile, there should be **no "Page Actions" toggle** in the mobile bar. Compare this to the [default setup](/examples/default/) page where page actions are visible.
